...
markers_jet = cv.applyColorMap((markers.astype(np.float32)*255/(ret + 1)).astype(np.uint8), cv.COLORMAP_JET)
src_img[markers == -1] = (255, 0, 0)
# display_image('result', src_img)
